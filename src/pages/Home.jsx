...
export function Home(){
    return(
        ...
        <main className="flex-grow pt-[100px]">
            ...
            <div id="our_history" className="w-full bg-old_paper h-full flex flex-col justify-center items-center">
            ...
            <div id="gallery" className="w-full bg-white py-20 flex flex-col items-center">
            ...
            <div id="cerimone_place" className="w-full bg-old_paper py-20 flex items-center justify-center flex-col">
